    ...
    function adjustSize() {
      ...
      if (mainContainer.classList.contains("has-search")) {
        mainContainer.style.top =
          SelectHead.getBoundingClientRect().top +
          15 +
          window.pageYOffset +
          "px";
        console.log("aqui");
...
function inicializar() {
  ...
  btnshow = document.getElementById("submit");
  btnshow.addEventListener("click", () => {
    formDemo = document.getElementById("form-demo");
    formDemo.addEventListener("submit", enviaraFirebase, false);
